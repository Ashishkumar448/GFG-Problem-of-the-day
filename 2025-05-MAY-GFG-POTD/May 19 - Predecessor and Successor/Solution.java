...
class Solution {
    public ArrayList<Node> findPreSuc(Node root, int key) {
        ...
        // Find the key, updating predecessor and successor along the way
        while (curr != null) {
            if (curr.data == key) {
                ...
                break; // key found, break
            } else if (key < curr.data) {
                suc = curr; // this node could be successor
                curr = curr.left;
            } else {
                pre = curr; // this node could be predecessor
                curr = curr.right;
            }
        }
