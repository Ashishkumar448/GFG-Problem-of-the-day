     ...
     public ArrayList<ArrayList<Integer>> levelOrder(Node root) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < levelSize; i++) {
                Node currentNode = queue.poll(); // Get and remove the front node
                currentLevel.add(currentNode.data); // Add current node's value to the level list
            ...
            result.add(currentLevel); // Add current level list to the result
        }
